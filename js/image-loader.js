		  	...
		  	//console.log(response.photos.photo.length);
  	  		...
  	  		for (i = 1; i < 5; ++i) {
				    ...
				    var photoID = item.id;
	                    ...
	                    var imgCont = '<div class="image-bg hiding " id="' + i + '"style="width:100%;height:100%;background-size:cover;background-repeat:no-repeat;background-position:center;background-image: url(' + photoURL + ');">'+'</div>';
